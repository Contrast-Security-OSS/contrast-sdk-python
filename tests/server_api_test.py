...
class ServerApiTest(TestCase):
    ...
    def get_servers_test(self):
        self.assertEqual(200, self.sdk.get_servers(self.org_uuid).status_code)
    ...
    def get_server_attack_status_test(self):
        self.assertEqual(200, self.sdk.get_server_attack_status(self.org_uuid, self.server_id).status_code)

    def get_server_attack_type_test(self):
        self.assertEqual(200, self.sdk.get_server_attack_types(self.org_uuid, self.server_id).status_code)

    def get_server_trace_breakdown_test(self):
        self.assertEqual(200, self.sdk.get_server_trace_breakdown(self.org_uuid, self.server_id).status_code)

    def get_server_trace_severity_breakdown_test(self):
        self.assertEqual(200, self.sdk.get_server_trace_severity_breakdown(self.org_uuid, self.server_id).status_code)

    def get_server_trace_status_breakdown_test(self):
        self.assertEqual(200, self.sdk.get_server_trace_status_breakdwon(self.org_uuid, self.server_id).status_code)

    def get_server_library_breakdown(self):
        self.assertEqual(200, self.sdk.get_server_libraries_breakdown(self.org_uuid, self.server_id).status_code)

    def update_server_name_test(self):
        self.assertEqual(200, self.sdk.update_server_name(self.org_uuid, self.server_id, 'python-sdk').status_code)

    def get_server_vuln_and_attack_urls_test(self):
        self.assertEqual(200, self.sdk.get_server_vuln_and_attack_urls(self.org_uuid, self.server_id).status_code)

    def get_server_properties_test(self):
        self.assertEqual(200, self.sdk.get_server_properties(self.org_uuid, self.server_id).status_code)

    def get_server_vuln_urls_test(self):
        self.assertEqual(200, self.sdk.get_server_vuln_urls(self.org_uuid, self.server_id).status_code)

    def get_server_attack_urls_test(self):
        self.assertEqual(200, self.sdk.get_server_attack_urls(self.org_uuid, self.server_id).status_code)

    def get_server_libraries_test(self):
        self.assertEqual(200, self.sdk.get_server_libraries(self.org_uuid, self.server_id).status_code)

    def get_server_libraries_subfilters_test(self):
        self.assertEqual(200, self.sdk.get_server_libraries_subfilters(self.org_uuid, self.server_id, 'apps').status_code)

    def filter_server_libraries_test(self):
        self.assertEqual(200, self.sdk.filter_server_libraries(self.org_uuid, self.server_id).status_code)

    def get_server_trace_subfilters_test(self):
        self.assertEqual(200, self.sdk.get_server_trace_subfilters(self.org_uuid, self.server_id, 'modules').status_code)

    def filter_server_traces_test(self):
        self.assertEqual(200, self.sdk.filter_server_traces(self.org_uuid, self.server_id).status_code)

    def delete_server_traces_test(self):
        try:
            self.assertEqual(200, self.sdk.delete_server_traces(self.org_uuid, self.server_id, []).status_code)
            assert False
